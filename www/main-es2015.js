...
var map = {
	...
	"./pages/politica-privacidade/politica-privacidade.module": [
	...
	"./pages/task-save/task-save.module": [
...
module.exports = "<ion-split-pane contentId=\"menu-content-tasks\" when=\"sm\">\n\n  <ion-menu contentId=\"menu-content-tasks\" menuId=\"main-menu-id\" [disabled]=\"true\">\n    \n    <ion-header>\n      <ion-toolbar color=\"primary\">\n          <ion-title>Menu</ion-title>\n      </ion-toolbar>\n    </ion-header>\n\n    <ion-content>\n      <ion-list>\n        <ion-list-header *ngIf=\"user\">\n          {{user.displayName}}\n        </ion-list-header>\n        <ion-menu-toggle autoHide=\"false\">\n            <ion-item \n            button \n            *ngFor=\"let page of pages\"\n            [routerLink]=\"page.url\"\n            [routerDirection]=\"page.direction\">\n              <ion-icon slot=\"start\" [name]=\"page.icon\"></ion-icon>\n              <ion-label>{{ page.text }}</ion-label>\n          </ion-item>\n        </ion-menu-toggle>\n      </ion-list>\n    </ion-content>\n  </ion-menu>\n\n  <ion-router-outlet id=\"menu-content-tasks\"></ion-router-outlet>\n</ion-split-pane>\n"
...
const routes = [
    ...
    { path: 'tasks', loadChildren: './tasks/tasks.module#TasksModule', canLoad: [_core_guards_auth_guard__WEBPACK_IMPORTED_MODULE_1__["AuthGuard"]] },
...
CoreModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        exports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_7__["IonicModule"]],
        providers: [
...
let AuthGuard = class AuthGuard {
    ...
    canActivate(activateRouteSnapshot, routerStateSnapshot) {
        return this.checkAuthState(routerStateSnapshot.url);
    }
    canActivateChild(activateRouteSnapshot, routerStateSnapshot) {
        return this.canActivate(activateRouteSnapshot, routerStateSnapshot);
    }
    canLoad(route, urlSegments) {
        const url = urlSegments.map(s => `/${s}`).join('');
        return this.checkAuthState(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["take"])(1));
    }
    checkAuthState(redirect) {
        return this.authService.isAuthenticated.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(is => {
            if (!is) {
...
/* harmony import */ var _auth_types__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./auth.types */ "./src/app/core/services/auth.types.ts");
...
let AuthService = class AuthService {
    ...
    get isAuthenticated() {
        return this.authState$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(user => user !== null));
    }
    orchestrator({ isSignIn, provider, user }) {
        let operation;
        if (provider !== _auth_types__WEBPACK_IMPORTED_MODULE_4__["AuthProvider"].Email) {
    ...
    signInWithPopup(provider) {
        ...
        switch (provider) {
            case _auth_types__WEBPACK_IMPORTED_MODULE_4__["AuthProvider"].Facebook:
                signInProvider = new firebase_app__WEBPACK_IMPORTED_MODULE_3__["auth"].FacebookAuthProvider();
                break;
        }
...
module.exports = __webpack_require__(/*! /home/carledwin/Documents/Ionic/projetos/IonicFireStoreTasks/src/main.ts */"./src/main.ts");
